...
export const PROGRAMS: Program[] = [
  {
    ...
    image: APP_ASSETS.graphicDesignDoc,
    imagePlaceholderText: "programs/graphic-design.jpg: Four young creatives reviewing printed graphic design work around a shared table (3:2)",
    featured: true,
    order: 1,
  ...
  },
  {
    ...
    image: APP_ASSETS.photographyStreetDoc,
    imagePlaceholderText: "programs/photography.jpg: Photographer framing a shot on Nairobi street while peers observe (3:2)",
    featured: true,
    order: 2,
  ...
  },
  {
    ...
    image: APP_ASSETS.animationDoc,
    imagePlaceholderText: "programs/animation.jpg: Animator working at desktop workstation with mentor reviewing timeline (3:2)",
    featured: true,
    order: 3,
  ...
  },
  {
    ...
    image: APP_ASSETS.musicProductionDoc,
    imagePlaceholderText: "programs/music-production.jpg: Producer working in home studio with MIDI keyboard and headphones (3:2)",
    featured: true,
    order: 4,
  ...
  },
  {
    ...
    image: APP_ASSETS.webUiUxDoc,
    imagePlaceholderText: "programs/ui-ux.jpg: Team reviewing website prototype on laptop and discussing interface (3:2)",
    featured: true,
    order: 5,
  ...
  },
  {
    ...
    image: APP_ASSETS.aiCreativesDoc,
    imagePlaceholderText: "programs/ai-creatives.jpg: Creatives experimenting with AI tools on laptops in a practical lab (3:2)",
    featured: true,
    order: 6,
