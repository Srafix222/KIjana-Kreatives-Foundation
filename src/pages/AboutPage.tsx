        ...
        <div className="max-w-[1240px] mx-auto px-4 sm:px-6 relative z-10 animate-kkf-rise">
          <div className="max-w-[800px]">
            ...
            <h1 className="font-['Poppins'] font-bold text-[30px] xs:text-[36px] sm:text-[48px] md:text-[54px] lg:text-[60px] leading-[1.1] tracking-[-0.03em] mb-4 sm:mb-6">
              A foundation built around young Kenyan talent.
            </h1>
            <p className="font-['Inter'] text-base sm:text-[18px] md:text-[20px] text-white/85 leading-[1.65] font-normal max-w-[660px]">
              We work with young people who already have ability, and give them the training, mentorship and opportunities to turn it into work.
            </p>
          </div>
        </div>
      </section>
