...
>
> Images capture real-looking moments of young Kenyan creatives learning, experimenting, collaborating, and building their skills in Nairobi, Kenya. Photography feels candid, human, and observational, with natural light, authentic environments, realistic skin texture, restrained color, and imperfect composition.
>
> The visual language resembles a **documentary photo essay or nonprofit annual report**, rather than commercial stock photography.
>
> - **Human > polished**
> - **Authentic > perfect**
...
### Standard Photographic DNA Style Block

```
Visual style: authentic documentary photography for a Kenyan youth creative foundation. Candid photojournalistic image captured during a real activity in Nairobi, Kenya. Natural available light, realistic exposure, soft natural shadows, neutral-to-slightly-muted color, accurate African skin tones, visible natural skin texture, realistic hair and clothing, ordinary lived-in environments, genuine human interaction, imperfect but intentional framing, realistic camera perspective, subtle depth of field, natural lens characteristics, documentary editorial photography, unposed moment, human and believable.

The photograph should feel like it was captured spontaneously by a photographer documenting a real nonprofit program for an annual report or photo essay.

Avoid: stock photography, commercial advertising photography, staged poses, everyone looking at camera, exaggerated smiles, perfect faces, perfect skin, glamour photography, cinematic movie lighting, dramatic rim lighting, HDR, excessive sharpness, excessive bokeh, oversaturation, orange-and-teal grading, glossy color grading, artificial studio lighting, futuristic environments, perfectly clean workspaces, perfectly arranged objects, unrealistic equipment, plastic-looking skin, distorted hands, duplicated people, AI-generated appearance.
```
...
- **Link**: `IMAGE_CATALOG.find(i => i.id === 'graphic-design-documentary').link`
- **Aspect Ratio**: `3:2`
...
### 2. Street Photography & Composition Practical
- **File**: `src/assets/images/photography_street_documentary_1788756875138.jpg`
- **Link**: `IMAGE_CATALOG.find(i => i.id === 'photography-street-documentary').link`
- **Aspect Ratio**: `3:2`
...
- **File**: `src/assets/images/animation_motion_documentary_1788756891423.jpg`
- **Link**: `IMAGE_CATALOG.find(i => i.id === 'animation-motion-documentary').link`
- **Aspect Ratio**: `3:2`
...
### 4. Music Production & Sound Engineering
- **File**: `src/assets/images/music_production_documentary_1788756909923.jpg`
- **Link**: `IMAGE_CATALOG.find(i => i.id === 'music-production-documentary').link`
- **Aspect Ratio**: `3:2`
...
### 5. Web & UI/UX Product Prototyping
- **File**: `src/assets/images/web_uiux_documentary_1788756936260.jpg`
- **Link**: `IMAGE_CATALOG.find(i => i.id === 'web-uiux-documentary').link`
- **Aspect Ratio**: `3:2`
...
### 6. AI Tools & Generative Workflows Lab
- **File**: `src/assets/images/ai_creatives_documentary_1788756951074.jpg`
- **Link**: `IMAGE_CATALOG.find(i => i.id === 'ai-creatives-documentary').link`
- **Aspect Ratio**: `3:2`
...
### 7. DSLR Camera Settings & Documentary Practical
- **File**: `src/assets/images/kkf_documentary_photo_1788756617210.jpg`
- **Link**: `IMAGE_CATALOG.find(i => i.id === 'kkf-documentary-field-practical').link`
- **Aspect Ratio**: `4:3`
...
- **Used In**: `HomePage` hero banner

### 9. Creative Academy Showcase & Exhibition Night
- **File**: `src/assets/images/showcase_documentary_1788763415110.jpg`
- **Aspect Ratio**: `16:9`
...
- **Used In**: `ImpactPage` hero banner, `HomePage` featured track

### 10. Alumni Spotlight: Emerging Kenyan Filmmaker
- **File**: `src/assets/images/filmmaker_spotlight_1788763433234.jpg`
- **Aspect Ratio**: `16:9`
...
- **Used In**: `StoriesPage` hero showcase

### 11. Cinema Rigging & Sound Stage Practical
- **File**: `src/assets/images/cinema_rigging_doc_1788763448366.jpg`
- **Aspect Ratio**: `16:9`
...
- **Used In**: `ProgramsPage` header, `StoryVideoModal` teaser

### 12. One-on-One Industry Mentor Guidance
- **File**: `src/assets/images/mentor_guidance_doc_1788763466076.jpg`
- **Aspect Ratio**: `3:4`
...
- **Used In**: `AboutPage` team section, `GetInvolvedPage`

### 13. Design Thinking & Group Collaboration Lab
- **File**: `src/assets/images/design_thinking_doc_1788763480003.jpg`
- **Aspect Ratio**: `4:3`
...
- **Used In**: `AboutPage` historical archive

### 14. Natural Light Field Photography Practice
- **File**: `src/assets/images/field_photo_practice_1788763494255.jpg`
- **Aspect Ratio**: `4:3`
...
- **Used In**: `ProgramsPage` photography curriculum

### 15. Acoustic Audio Booth & Mixing Console
- **File**: `src/assets/images/audio_booth_space_1788763508180.jpg`
- **Aspect Ratio**: `16:9`
...
- **Used In**: `ProgramsPage` audio curriculum

### 16. Motion Design & 3D Keyframe Workspace
- **File**: `src/assets/images/motion_3d_workspace_1788763523066.jpg`
- **Aspect Ratio**: `16:9`
...
- **Used In**: `ProgramsPage` animation curriculum

### 17. User Journey Mapping & Wireframe Testing
- **File**: `src/assets/images/uiux_wireframe_doc_1788763539885.jpg`
- **Aspect Ratio**: `16:9`
...
- **Used In**: `ProgramsPage` UI/UX curriculum

### 18. Creative Workshop Studio Overview
- **File**: `src/assets/images/workshop_overview_doc_1788763553237.jpg`
- **Aspect Ratio**: `4:3`
...
- **Used In**: `AboutPage` header

### 19. KKF Community Brand Overview
- **File**: `src/assets/images/community_brand_doc_1788763567813.jpg`
- **Aspect Ratio**: `16:9`
...
- **Used In**: Archive & Brand repository
...
- **Used In**: `AboutPage` leadership team

### 21. Achieng Omondi (Lead Curriculum Director)
- **File**: `src/assets/images/curriculum_lead_doc_1788763599419.jpg`
- **Aspect Ratio**: `1:1`
...
### 22. Brian Mwangi (Head of Partnerships & Placements)
- **File**: `src/assets/images/partnerships_doc_1788763613248.jpg`
- **Aspect Ratio**: `1:1`
